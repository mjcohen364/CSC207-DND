...
import interface_adapter.character_name.SignupController;
import interface_adapter.character_name.SignupPresenter;
import interface_adapter.character_name.SignupViewModel;
import use_case.clear_users.ClearInputBoundary;
import use_case.clear_users.ClearInteractor;
import use_case.clear_users.ClearOutputBoundary;
import use_case.clear_users.ClearUserDataAccessInterface;
import use_case.character_name.SignupInputBoundary;
import use_case.character_name.SignupInteractor;
import use_case.character_name.SignupOutputBoundary;
...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createUserClearUseCase(viewManagerModel, signupViewModel, clearViewModel, clearUserDataAccessInterface);
    ...
    private static ClearController createUserClearUseCase(ViewManagerModel viewManagerModel, SignupViewModel signupViewModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface userDataAccessObject) throws IOException {
